...
# 优雅地开发 MCP 服务器（二）OpenMCP 使用教程 & 你的第一个 MCP 服务

[本期教程视频版本](https://www.bilibili.com/video/BV1zYGozgEHc)

## hook

等等，开始前，先让我们看一个小例子，假设我下周要去明日方舟锈影新生的漫展，所以我想要知道周六杭州的天气，于是我问大模型周六的天气，结果大模型给了我如下的回复：

![](https://picx.zhimg.com/80/v2-4c623ac6897e12093535b0d9ed9cf242_1440w.png)
...
![](https://picx.zhimg.com/80/v2-525c4576398078547fdd6eeef26532aa_1440w.png)
...
![](https://picx.zhimg.com/80/v2-f67e000371095a755d2f0d613706d61c_1440w.png)
...
![](https://picx.zhimg.com/80/v2-c4ebbbfe98d51e8b6e7de6c6d1bceb2e_1440w.png)
...
![](https://pic1.zhimg.com/80/v2-684190b98dbbb9a7bf0e8c8048bd1277_1440w.png)

### 初识 OpenMCP

接下来，我来简单介绍一下 OpenMCP 的基本功能模块，如果一开始，你的屏幕里什么也没有，先点击上面的加号创建一个新的标签页，此处页面中会出现下图屏幕中的四个按钮

![](https://picx.zhimg.com/80/v2-3a4e8aa1ddaac632601532bb757a15ad_1440w.png?source=d16d100b)

放大一点

![](https://picx.zhimg.com/80/v2-ecc0705ed534e2cf0bc748ecd95f5f22_1440w.png)

前三个，资源、提词和工具，分别用于调试 MCP 中的三个对应项目，也就是 Resources，Prompts 和 Tools，这三个部分的使用，基本和 MCP 官方的 Inspector 工具是一样的，那是自然，我就照着这几个抄的，诶嘿。

![](https://pica.zhimg.com/80/v2-d767e782f667161442ea183f55ca49b1_1440w.png)

然后第四个按钮「交互测试」，它是一个我开发的 MCP 客户端，其实就是一个对话窗口，你可以无缝衔接地直接在大模型中测试你当前的 MCP 服务器的功能函数。

![](https://picx.zhimg.com/80/v2-b59ee2d290e096343fb4659baf34cf57_1440w.png)
...
![](https://picx.zhimg.com/80/v2-1c67ab54d67023e408413484768377cf_1440w.png)

然后此时，你在左侧的列表可以看到 weather 这个工具，选择它，然后在右侧的输入框中随便输入一些东西，按下回车（或者点击「运行」），你能看到如下的响应：

![](https://picx.zhimg.com/80/v2-d32a9c0d9fcab497dc03152a72c4c62b_1440w.png)
...
![](https://pic1.zhimg.com/80/v2-367780b204d2aa50354585272b71af20_1440w.png)

再新建一个标签页，选择「交互测试」，此时，我们就可以直接和大模型对话了，我们先看看没有任何工具注入的大模型会如何回应天气预报的问题，点击最下侧工具栏从左往右第三个按钮，进入工具选择界面，选择「禁用所有工具」

![](https://pic1.zhimg.com/80/v2-977a53ea14eae5e1a646fc73d379a422_1440w.png)
...
![](https://pic1.zhimg.com/80/v2-d3aa56602f574a6968295f9a5c93438f_1440w.png)

可以看到，大模型给出了和文章开头一样的回答。非常敷衍，因为它确实无法知道。

此处，我们再单独打开「weather」工具：

![](https://picx.zhimg.com/80/v2-2ed66eaff604d11d52f60201fca215d4_1440w.png)

问出相同的问题：

![](https://picx.zhimg.com/80/v2-e934d386e20b1de43fb5e0dd426de86e_1440w.png)
...
![](https://picx.zhimg.com/80/v2-d2dbe925010b676482ee57258c14fca7_1440w.png)
...
![](https://picx.zhimg.com/80/v2-e581c6461190b358adda50ce83633520_1440w.png)
